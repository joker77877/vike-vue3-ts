  ...
  plugins: [vue(), vike(),VueDevTools(),
    Components({
      ...
      resolvers: [
        ...
        AntDesignVueResolver({ importStyle: "less", cjs: true}),
        IconsResolver({
          prefix: false,
    ...
    resolve: { alias: { "@": fileURLToPath(new URL("./src", import.meta.url)) ,find: 'element-plus/lib', replacement: 'element-plus/dist/index.esm.js' } }
} 
